...
optional_refusal(article19_1_b, ExecutingMemberState, europeanConfiscationOrder):-
    regulation_matter(IssuingMemberState, ExecutingMemberState, europeanConfiscationOrder),
    confiscation_prevented(europeanConfiscationOrder, ExecutingMemberState).

confiscation_prevented(europeanConfiscationOrder, ExecutingMemberState):-
    contrast_with(europeanConfiscationOrder, ExecutingMemberState, immunity_privilege).
        
confiscation_prevented(europeanConfiscationOrder, ExecutingMemberState):-
    contrast_with(europeanConfiscationOrder, ExecutingMemberState, freedom_press)
;   contrast_with(europeanConfiscationOrder, ExecutingMemberState, freedom_expression_media).
